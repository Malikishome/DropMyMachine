...
function Home() {
    ...
    return (
        ...
        <h2 className="text-4xl text-center mb-4"><GradientText>DropMyMachine</GradientText></h2>
        <p className="text-lg text-center mt-2 text-white">The fastest way to connect machine owners with high-traffic locations.</p>

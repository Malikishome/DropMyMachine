...
function Home() {
    ...
    return (
        ...
        <Link to="/login"><button className="bg-blue-500 text-white px-4 py-2 rounded-xl mt-4 hover:bg-blue-600">Login</button>
        </Link>
        <Link to="/register"><button className="bg-blue-500 text-white px-4 py-2 rounded-xl mt-4 hover:bg-blue-600">Get Started</button>
        </Link>
        </div>
    );
  }
